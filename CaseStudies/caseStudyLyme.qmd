...
Let's do an ordination. How do lyme patients resemble one another? \@ref(fig:caseStudyLymeOrdination1)

```{r caseStudyLymeOrdination1, fig.cap = "Clusters of lyme patients"}
...
sink("junk.txt")
lyme.ord <- ordinate(lyme.ps, method = "NMDS", distance = "bray")
lyme.df <- plot_ordination(lyme.ps,lyme.ord,justDF = TRUE)
sink()


ggplot(data=lyme.df,aes(x=NMDS1,y=NMDS2, color = Username)) + geom_point() +
