...
```{r child="Experiments/experiment-probiotics.qmd"}

```

```{r child="Experiments/experiment_akkermansia.qmd"}
```


<!-- ```{r child="Experiments/experiment-dentist.qmd"} -->
...
{{< include Experiments/microbesInMouth.qmd >}}


{{< include Experiments/experiment-dentist.qmd >}}


<!-- ```{r child="Experiments/microbesInMouth.qmd"} -->
