...
The remaining shortcut is possible thanks to years of research of sequencing the genes in bacteria. Scientists in labs around the world have been faithfully digging up samples of bacteria, and performing whole-gene sequencing on what they find. Although 250 base pairs may seem like a tiny number to differentiate among all possible bacteria on earth, for gut microbiome purposes we need concern ourselves only with those that are known to inhabit humans. The Human Microbiome Project already identified most of these bacteria -- and their 16S gene identifiers -- so armed with that as a reference database^[A very popular one is Greengenes: http://greengenes.secondgenome.com/downloads. Learn about all the big ones [@balvociute_silva_2017 Fig 3]], it is generally possible to unmask a specific microbe with just a sliver of DNA.
